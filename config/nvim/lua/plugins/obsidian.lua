...
return {
  {
    ...
    opts = {
      ...
      workspaces = {
        {
          name = "SENTU", -- Name of the workspace
          path = "~/Documentos/obsidian/SENTU/", -- Path to the notes directory
        },
      },
      ...
      notes_subdir = "00 - Limbo", -- Subdirectory for notes
      new_notes_location = "00 - Limbo", -- Location for new notes
      ...
      templates = {
        subdir = "99 - Meta/00 - Template", -- Subdirectory for templates
